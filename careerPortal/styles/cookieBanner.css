...
/* Animated cookie icon with accent color */
...
/* Links with accent color - BIGGER */
.cookie-banner-links {
    display: flex;
    align-items: center;
    gap: 12px;
...
/* Accept button - Primary accent - MUCH LARGER TEXT */
.cookie-btn-accept {
    background: var(--button-primary);
    color: #ffffff;
    box-shadow: 0 4px 12px var(--glow-color-light);
    font-size: calc(var(--font-sm) * 1.69); /* 1.3 * 1.3 = 1.69 */
}
...
/* Collapsed cookie button - Light theme - ICON ONLY */
...
@media (max-width: 768px) {
    ...
    /* Larger button text on mobile - maintain increased sizes */
    .cookie-btn-accept {
        font-size: calc(var(--font-sm) * 1.69);
    }
...
/* Dark mode override - Keep light theme but adjust shadows */
